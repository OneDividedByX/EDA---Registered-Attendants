...
\begin{document}
    ...
    \chapter*{Introducción}\addcontentsline{toc}{chapter}{Introducción}
        ...
        El trabajo de practicante pre-profesional corresponde al de \textit{Tutor} en la Universidad Tecnológica del Perú y tiene como función el dictado de clases de reforzamiento en cursos de matemática a los estudiantes de la misma. Esto beneficia a los estudiantes de la sede \textit{UTP - Lima Centro} (presencial) y a estudiantes de las diferentes sedes del país (virtual).

        La permanencia en el cargo de Tutor es determinada por la institución según el cumplimiento del reglamento y la calificación de satisfacción que los estudiantes asignan al Tutor de turno en las sesiones mediante encuestas.
    \chapter*{Antecedentes}\addcontentsline{toc}{chapter}{Antecedentes}
        ...
        \chapter{Resultados}
            ...
            Se resalta el hecho de que todos los archivos de datos y visualizaciones se encuentran en el repositorio de \textit{GitHub} \cite{Report:Origin}.
            \newpage
        ...
        \section{Inscritos y participantes}
            ...
            \subsection{Inscritos-Participantes}
                ...
                \begin{observacion}
                    ...
                    Sin embargo, esta tabla se puede encontrar en el repositorio de \textit{GitHub} \cite{Report:Origin} en el archivo $\mathsf{.ipynb}$.
                \end{observacion}
    ...
    \chapter{Conclusiones}
        \begin{enumerate}
            ...
            \item Se espera que de una cantidad de alumnos inscritos en cualquier tipo o curso, aproximadamente el $70\%$ de ellos asistan a la misma. Más específicamente, se espera que de cierta cantidad de inscritos a una sesión
            \begin{enumerate}
                \item en el curso de Matemática I aproximadamente el $72.7\%$ de ellos asistan a la misma;
                \item en el curso de Matemática II aproximadamente el $70.7\%$ de ellos asistan a la misma;
                \item en el curso de Cálculo I aproximadamente el $71.0\%$ de ellos asistan a la misma;
                \item en el curso de Cálculo II aproximadamente el $67.7\%$ de ellos asistan a la misma;
                \item en el curso de Estadística Descriptiva aproximadamente el $51.4\%$ de ellos asistan a la misma;
                \item en el curso de Geometría aproximadamente el $69.6\%$ de ellos asistan a la misma;
                \item en el curso de Matemática para Medicina aproximadamente el $40.9\%$ de ellos asistan a la misma.
            \end{enumerate}
            \item La duración de las sesiones en talleres suele ser la máxima establecida ($90\,\textup{min}$), mientras que en las tutorías suele ser la mitad de su máxima establecida ($20\,\textup{min}$).
