...
\rhead[\textcolor{black}{\leftmark}]{\includegraphics[scale=0.02]{Carátula/Uni-logo_transparente.png}}
...
\begin{document}
    ...
    \chapter{Antecedentes}
        ...
        \section{Métricas estadísticas}
            ...
            \end{definicion}
            \begin{definicion}[Exceso de kurtosis]
                
            \end{definicion}
            \begin{definicion}[Coeficiente de correlación (Pearson)]
                
            \end{definicion}
            \begin{definicion}[Matriz de correlación]
