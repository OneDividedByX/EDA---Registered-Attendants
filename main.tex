    ...
    \chapter{Discusión}        
        ...
        \section{Inscritos y participantes}
            ...
            \subsection{Inscritos-Participantes}
                ...
                \end{equation*}
                y deberíamos ser capaces de verificar que $A-0.69I+0.643\sim\varepsilon_I\sim\mathcal{N}(0,\sigma_I^2)$ mediante el contraste de hipótesis de heterocedasticidad.
    ...
    \chapter{Anexos}
        ...
        \section{Métricas estadísticas}
            ...
            \begin{definicion}[Nivel de significación]
                Sea un estadístico $s$ en un contraste de hipótesis con hipótesis nula $H_0$. Sea $Z$ normal estándar, decimos que $\alpha\in [0;1]$ es un nivel de significación en los siguientes casos:
                \begin{itemize}
                    ...
                    \item \textbf{Dos colas:} $\alpha=\Prob{|Z| > z_{\frac{\alpha}{2}}}$ o $1-\alpha=\Prob{|Z| \leq z_{\frac{\alpha}{2}}}$.
                            ...
                            \end{itemize}
                \end{itemize}
                En todos los casos $z_{\alpha}$ es el cuantil normal de nivel $1-\alpha$. Cuando $\alpha=0.05$, entonces $z_{0.05}\approx1.96$.
            \end{definicion}
            ...
            \begin{ejemplo}[Contraste de normalidad (Shapiro-Wilk)]
                ...
                El estadístico de contraste está dado por
                    ...
                    \end{itemize}
                Luego, para un nivel de significación \(\alpha\),
                \begin{itemize}
                    \item Si \(W < z_{\alpha}\), se rechaza $H_{0}$.
                    \item Si \(W \geq z_{\alpha}\), no se rechaza (o se acepta que se tiene suficiente evidencia) $H_{0}$.
                \end{itemize}
            \end{ejemplo}
